...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (ModuleManager.isClientEnabled() && ModuleManager.isCpsEnabled())
        {
            String cpsText = "CPS: " + ModuleManager.getCps();
            int cpsY = this.mc.gameSettings.showDebugInfo ? 116 : 5;
            drawRect(3, cpsY - 2, 8 + var8.getStringWidth(cpsText), cpsY + 10, -1610612736);
            var8.drawStringWithShadow(cpsText, 6, cpsY, 16777215);
        }
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            GL11.glPushMatrix();
            var8.drawStringWithShadow("Minetap 1.2 (" + this.mc.debug + ")", 2, 2, 16777215);
