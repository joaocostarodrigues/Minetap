...
public abstract class Minecraft implements Runnable, IPlayerUsage {
				...
				if (Keyboard.getEventKeyState()) {
					if (Keyboard.getEventKey() == 87) {
						...
						if (this.currentScreen != null) {
							...
							//OCIPE
							if (Keyboard.getEventKey() == 45) { Ocipe.moduleManager.onKey(Keyboard.KEY_X);
							}
							//OCIPE
							if (Keyboard.getEventKey() == 33) { Ocipe.moduleManager.onKey(Keyboard.KEY_F);
							}
							if (Keyboard.getEventKey() == 46) { Ocipe.moduleManager.onKey(Keyboard.KEY_C);
							}
	...
	/**
	 * Installs a resource. Currently only sounds are download so this method just
	 * adds them to the SoundManager.
	 */
